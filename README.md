...
`@mageswap/v3-periphery`
and import bytecode imported from artifacts located at
`@mageswap/v3-periphery/artifacts/contracts/*/*.json`.
For example:
...
} from '@mageswap/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
via the npm artifact `@mageswap/v3-periphery`, e.g.:

```solidity
import '@mageswap/v3-periphery/contracts/interfaces/ISwapRouter.sol';
